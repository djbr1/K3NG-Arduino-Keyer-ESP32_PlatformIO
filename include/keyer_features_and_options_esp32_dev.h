...
// #define FEATURE_LCD_4BIT                // classic LCD disidefplay using 4 I/O lines // disabled to free pins for pressure paddles
...
// #define FEATURE_CAPACITIVE_PADDLE_PINS  // remove the bypass capacitors on the paddle_left and paddle_right lines when using capactive paddles
 ...
 //#define TIMING_PRESSURE_PADDLES
...
// #define OPTION_DO_NOT_SAY_HI  // disabled welcome HI at boot
